	...
	<div id="tridiv">
	  <div class="scene" style="-webkit-transform:rotateX(-19deg) rotateY(63deg); -moz-transform:rotateX(-19deg) rotateY(63deg); -ms-transform:rotateX(-19deg) rotateY(63deg); transform:rotateX(-19deg) rotateY(63deg); ">
	    <div class="shape cuboid-1 cub-1">
	      <div class="face ft">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.172549);"></div>
	      </div>
	      <div class="face bk">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.172549);"></div>
	      </div>
	      ...
	      <div class="face tp">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 1);"></div>
	      </div>
	    </div>
	    <div class="shape cuboid-2 cub-2">
	      <div class="face ft">
	        <div class="photon-shader" style="background-color: rgba(79,22,54, 0.172549);"></div>
	      </div>
	      <div class="face bk">
	        <div class="photon-shader" style="background-color: rgba(79,22,54, 0.172549);"></div>
	      </div>
