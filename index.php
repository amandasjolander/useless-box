...
<body class="clearfix">
	...
	<div class="count">
		<div class="count-box visitors">
			<span>
				Visitors
			</span>
		</div>
		<div class="count-box total-click">
			<span>
				Click
			</span>
		</div>
	  ...
	  <!-- Cube 1 -->
	    ...
	    <div class="shape cylinder-1 cyl-1">
	      ...
	      <div class="face side s6">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.478431);"></div>
	      </div>
	      <div class="face side s7">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.592157);"></div>
	      </div>
	      <div class="face side s8">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.658824);"></div>
	      </div>
	      <div class="face side s9">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.596078);"></div>
	      </div>
	    ...
	    <div class="shape cylinder-2 cyl-2 switch">
	      ...
	      <div class="face side s0">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0352941);"></div>
	      </div>
	      <div class="face side s1">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0431373);"></div>
	      </div>
	      <div class="face side s2">
	      ...
	      <div class="face side s4">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.309804);"></div>
	      </div>
	      <div class="face side s5">
	      ...
	      <div class="face side s7">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.560784);"></div>
	      </div>
	      <div class="face side s8">
	      ...
	      <div class="face side s11">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.286275);"></div>
	      </div>
	      <div class="face side s12">
	    ...
	    <div class="shape cylinder-3 cyl-3 closer">
	      <div class="face bm">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0588235);"></div>
	      </div>
	      <div class="face tp">
	      ...
	      <div class="face side s6">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.490196);"></div>
	      </div>
	      <div class="face side s7">
	      ...
	      <div class="face side s12">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.211765);"></div>
	      </div>
	      <div class="face side s13">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.105882);"></div>
	      </div>
	    </div>
	    <div class="shape cylinder-4 cyl-4 closer">
	      <div class="face bm">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0588235);"></div>
	      </div>
	      <div class="face tp">
	      ...
	      <div class="face side s7">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.556863);"></div>
	      </div>
	      <div class="face side s8">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.537255);"></div>
	      </div>
	    ...
	    <div class="shape cylinder-5 cyl-5 closer">
	      <div class="face bm">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0588235);"></div>
	      </div>
	      <div class="face tp">
	      ...
	      <div class="face side s2">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.196078);"></div>
	      </div>
	      <div class="face side s3">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0588235);"></div>
	      </div>
	      ...
	      <div class="face side s9">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.4);"></div>
	      </div>
	      <div class="face side s10">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0588235);"></div>
	      </div>
	      ...
	      <div class="face side s13">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0705882);"></div>
	      </div>
	    </div>
	    <div class="shape cylinder-6 cyl-6 closer">
	      <div class="face bm">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0588235);"></div>
	      </div>
	      <div class="face tp">
	      ...
	      <div class="face side s0">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.0862745);"></div>
	      </div>
	      <div class="face side s1">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.164706);"></div>
	      </div>
	      <div class="face side s2">
	      ...
	      <div class="face side s4">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.45098);"></div>
	      </div>
	      <div class="face side s5">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.521569);"></div>
	      </div>
	      <div class="face side s6">
	      ...
	      <div class="face side s8">
	        <div class="photon-shader" style="background-color: rgba(0, 0, 0, 0.435294);"></div>
	      </div>
	      <div class="face side s9">
